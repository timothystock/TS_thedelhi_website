...
?>
	...
	<div class="grid-x woocommerce-shipping-totals shipping" data-title="<?php echo esc_attr( $package_name ); ?>">
		<div class="cell auto"><h5><?php echo wp_kses_post( $package_name ); ?></h5></div>
				...
				<ul id="shipping_method" class="woocommerce-shipping-methods">
					<?php foreach ( $available_methods as $method ) : ?>
						<li>
							...
							printf( '<label class="h5" cfor="shipping_method_%1$s_%2$s">%3$s</label>', $index, esc_attr( sanitize_title( $method->id ) ), wc_cart_totals_shipping_method_label( $method ) ); // WPCS: XSS ok.
		...
		<div class="cell">
			<?php esc_html_e( 'Enter your address to view shipping options.', 'woocommerce' ); ?>
				</div>
		<?php elseif ( ! is_cart() ) :?>
		<div class="cell">
